...
const openai = new OpenAI({
  apiKey: 'sk-WD3D6tr7pd42Z47DPxIY_WWRX8BhtXDJUaAhFZBcS0T3BlbkFJx8k_ZwUJvMgLnlACusWJAVdkwy10--9v5ql4XARZEA' // Ensure the API key is either passed via environment variables
});
